...
// Auto-detect environment: use nginx proxy in production, direct connection in dev
const isProduction = typeof window !== 'undefined' && (window.location.port === '' || window.location.port === '80' || window.location.port === '443');
